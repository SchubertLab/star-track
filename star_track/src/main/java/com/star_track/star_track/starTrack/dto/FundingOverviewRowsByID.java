/**
 * FundingOverviewRowsByID DTO (Data Transfer Object) class
 * Used for transferring funding overview data by ID.
 * Represents a structure for retrieving or displaying funding overview information.
 */
